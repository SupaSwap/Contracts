...
contract ToadBusdFarm is Ownable {
    ...
    string public name = "Toad Busd Farm";
    string public symbol = "TBUF";
    ...
    constructor() public {
        ...
        toadBep20 = TOKEN(address(0x463E737D8F740395ABf44f7aac2D9531D8D539E9)); //toad
        toadBnbBep20 = TOKEN(address(0x15aff98391f928693F55b70b8F4D787031Ad6f74)); //toad-bnb
    }
    ...
    function checkAndTransferToad(uint256 _amount) private {
        require(toadBep20.transferFrom(msg.sender, address(this), _amount) == true, "transfer must succeed");
    }
    function checkAndTransferToadBnb(uint256 _amount) private {
        require(toadBnbBep20.transferFrom(msg.sender, address(this), _amount) == true, "transfer must succeed");
    }
    ...
    function withdraw() hasDripped onlyDivis public {
        ...
        toadBep20.transfer(_customerAddress, _dividends);
    ...
    function deposit(uint256 _amount) hasDripped public returns (uint256) {
        checkAndTransferToadBnb(_amount);
    ...
    function sell(uint256 _amountOfTokens) isActivated hasDripped onlyTokenHolders public {
        ...
        toadBnbBep20.transfer(_customerAddress, _amountOfTokens);
    ...
    function totalTokenBalance() public view returns (uint256) {
        return toadBnbBep20.balanceOf(address(this));
    }
